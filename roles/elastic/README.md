Ansible role: Elasticseaerch
===================
Ansible role for 7.x/8.x Elasticsearch:
* Debian 10
...
* This role is heavily based on the [archived official Elasticsearch roles](https://github.com/elastic/ansible-elasticsearch)